...
import ArticleForm from './components/ArticleDetails';

const articles =[{title:"Développeur web : quelles compétences pour exercer le métier ?", date:"19/04/2019",smallDescription:"Le métier de développeur web est en plein essor, vous êtes de plus en plus nombreux à vous tourner vers cette profession et vous avez bien raison : ce profil est actuellement très recherché dans les entreprises Mais pour décrocher le job idéal  encore faut-il avoir les bonnes compétences  La technicité du développement web demande des connaissances variées en langage de programmation et une adaptation constante à leurs évolutions",Img :"https://www.codeur.com/blog/wp-content/uploads/2018/12/codeur-developpeur-web-700x525.jpg", id:"1"},
            ...
            <Router>
                <div>
                    ...
                    <Switch>
                        ...
                        <Route path="/blog/:id" render={ (props) =>  <ArticleForm {...props} articles={articles} /> } />
                    </Switch>
                </div>
            </Router>
        )
